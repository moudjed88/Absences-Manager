...
const NewSesion = ({ setShowAddSesion }) => {
  ...
  const [Newtype, setNewtype] = useState("kk");
  const [newGroup, setNewGroup] = useState("");

  let navigate = useNavigate();

  const handleCreate = (e) => {
    console.log(newDate,Time,Newtype,Newmodule,newGroup)
    e.preventDefault();
      ...
      .then((res) => {
        ...
        navigate("/studentsbygroup", {
          state: {
            ...
            speciality:Newmodule,
            sesionGroup:newGroup
          },
        });
      })
      .catch((err) => {
        ...
        <form>
          ...
          <div className="select-inputs">
            ...
            <select
              ...
              id="group"
              defaultValue=""
              onChange={(e) => {setNewGroup(e.target.value); console.log(newGroup)}}
            >
              <option disabled value="">
                {""}
              </option>
